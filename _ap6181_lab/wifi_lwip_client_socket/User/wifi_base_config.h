...
#define AP_SSID              "Redmi_5CD3"     /* 路由名称 */
#define AP_PASS              "mousesostrong"  /* 路由密码 */
#define AP_SEC               WICED_SECURITY_WPA2_MIXED_PSK  /* 路由加密 */

#define COUNTRY              WICED_COUNTRY_CHINA       /* 中国区 */
...
#define DEST_IP_ADDR3               247

#define DEST_PORT                   5500
...
extern struct netif g_wiced_if;
